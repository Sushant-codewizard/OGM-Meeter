...
SYSTEM_PROMPT = (
    ...
    "transcript. Use empty arrays when evidence is missing. Preserve exact participant names "
    "as they appear in the transcript; if a speaker's real name is never stated, use their "
    "diarization label (e.g. SPEAKER_00) as their participant name. The transcript may be in "
    "Hindi, English, Hinglish (code-mixed Hindi/English), or transcribed in Devanagari, Latin, "
    "or Urdu script — read it in whatever language or script it appears, and always write the "
    "summary, key topics, decisions, and action items in clear English.\n\n"
